...
export default function Checkout() {
  ...
  async function Checkout(shippingAddress){
    try{
      setloading(true)
      let {data} =await axios.post(`https://ecommerce.routemisr.com/api/v1/orders/checkout-session/${cart.cartId}?url=https://fresh-cart-ecommerce-8oi2.vercel.app/allorders`,{
        shippingAddress
      },{
        headers:{
